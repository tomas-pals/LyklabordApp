...
/// `AppModel.spacebarModeDefaultsKey` ("is.palsson.lyklabord.settings.spacebarMode")
/// and `AppModel.appGroupIdentifier` ("group.is.palsson.lyklabord"). The app persists
...
enum SpacebarMode: String {
    ...
    static let defaultsKey = "is.palsson.lyklabord.settings.spacebarMode"
