...
//  │   container iCloud.is.palsson.lyklabord, document-scope-public → visible &       │
...
final class RecordingStore {
    ...
    static let ubiquityContainerId = "iCloud.is.palsson.lyklabord"
    ...
    static let kbVersionKey = "is.palsson.lyklabord.dev.kbVersion"
